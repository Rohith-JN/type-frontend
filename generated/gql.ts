 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createTest($chars: String!, $wpm: Float!, $accuracy: Float!, $time: String!, $uid: String!, $testTaken: String!) {\n  createTest(\n    chars: $chars\n    wpm: $wpm\n    accuracy: $accuracy\n    time: $time\n    uid: $uid\n    testTaken: $testTaken\n  ) {\n    time\n    accuracy\n    wpm\n    chars\n    testTaken\n  }\n}"): (typeof documents)["mutation createTest($chars: String!, $wpm: Float!, $accuracy: Float!, $time: String!, $uid: String!, $testTaken: String!) {\n  createTest(\n    chars: $chars\n    wpm: $wpm\n    accuracy: $accuracy\n    time: $time\n    uid: $uid\n    testTaken: $testTaken\n  ) {\n    time\n    accuracy\n    wpm\n    chars\n    testTaken\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
