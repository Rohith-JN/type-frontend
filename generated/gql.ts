 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createTest($words: String!, $wpm: Float!, $accuracy: Float!, $time: String!, $uid: String!, $testTaken: String!) {\n  createTest(\n    words: $words\n    wpm: $wpm\n    accuracy: $accuracy\n    time: $time\n    uid: $uid\n    testTaken: $testTaken\n  ) {\n    time\n    accuracy\n    wpm\n    words\n    testTaken\n  }\n}"): (typeof documents)["mutation createTest($words: String!, $wpm: Float!, $accuracy: Float!, $time: String!, $uid: String!, $testTaken: String!) {\n  createTest(\n    words: $words\n    wpm: $wpm\n    accuracy: $accuracy\n    time: $time\n    uid: $uid\n    testTaken: $testTaken\n  ) {\n    time\n    accuracy\n    wpm\n    words\n    testTaken\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
