 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createTest($chars: String!, $wpm: Float!, $rawWpm: Float!, $accuracy: Float!, $time: String!, $uid: String!, $testTaken: String!) {\n  createTest(\n    testOptions: {chars: $chars, wpm: $wpm, rawWpm: $rawWpm, accuracy: $accuracy, time: $time, uid: $uid, testTaken: $testTaken}\n  ) {\n    id\n    creatorId\n    time\n    accuracy\n    wpm\n    rawWpm\n    chars\n    testTaken\n    createdAt\n  }\n}"): (typeof documents)["mutation createTest($chars: String!, $wpm: Float!, $rawWpm: Float!, $accuracy: Float!, $time: String!, $uid: String!, $testTaken: String!) {\n  createTest(\n    testOptions: {chars: $chars, wpm: $wpm, rawWpm: $rawWpm, accuracy: $accuracy, time: $time, uid: $uid, testTaken: $testTaken}\n  ) {\n    id\n    creatorId\n    time\n    accuracy\n    wpm\n    rawWpm\n    chars\n    testTaken\n    createdAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Leaderboard($uid: String!, $time: String!) {\n  leaderboard(uid: $uid, time: $time) {\n    leaderBoard {\n      rank\n      user\n      wpm\n      rawWpm\n      time\n      accuracy\n      testTaken\n    }\n    user {\n      rank\n      user\n      wpm\n      rawWpm\n      time\n      accuracy\n      testTaken\n    }\n  }\n}"): (typeof documents)["query Leaderboard($uid: String!, $time: String!) {\n  leaderboard(uid: $uid, time: $time) {\n    leaderBoard {\n      rank\n      user\n      wpm\n      rawWpm\n      time\n      accuracy\n      testTaken\n    }\n    user {\n      rank\n      user\n      wpm\n      rawWpm\n      time\n      accuracy\n      testTaken\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
